    ...
    <div className="pp flex items-center justify-around landing">
      <div className="landingPageText mx-6">
        ...
        <div > {/* Measures */}
            ...
            <h2 className="sub">
              2) <span className="text-red">Avoid</span> Exposure to Indoor Pollutants
            </h2>
            <img className="prev-image" src={require("../images/indoorpollutants.jpg")} alt="" />
            <b className="prev-body">
            ...
            <br /> The air you breathe in your home or office may be hazardous to your health - more dangerous, in fact, than the outdoor air in the most polluted of cities. This is especially so during the cold months, when windows and doors are kept tightly shut and homes, schools and office buildings are made as airtight as possible to conserve energy.

            <br /> Many people don't realize that their ''perpetual cold'' or other nagging symptoms may be caused by the very air they breathe in their own homes, at school or on the job. Some have been plagued for years and have visited doctor after doctor in a vain attempt to uncover the cause of their problem.

            <br /> Once the real culprit is suspected or identified, many sources of indoor pollution can be greatly reduced and perhaps prevented entirely, sometimes with little loss of costly heat to the great outdoors.


            </b>
            <h2 className="sub">
            3)<span className="text-red">Minimize</span> Exposure to Outdoor Air Pollution    
            </h2>
            <img className="prev-image" src={require("../images/pollution.jpg")} alt="" />
            <b className="prev-body">
            ...
            <br />
            The health effects of air pollution remain a public health concern worldwide. Exposure to air pollution has many substantial adverse effects on human health. Globally, seven million deaths were attributable to the joint effects of household and ambient air pollution. Subjects with chronic respiratory diseases such as chronic obstructive pulmonary disease (COPD) and asthma are especially vulnerable to the detrimental effects of air pollutants. Air pollution can induce the acute exacerbation of COPD and onset of asthma, increase the respiratory morbidity and mortality. The health effects of air pollution depend on the components and sources of pollutants, which varied with countries, seasons, and times. <br /> Combustion of solid fuels is a major source of air pollutants in developing countries. <br /> To reduce the detrimental effects of air pollution, people especially those with COPD or asthma should be aware of the air quality and take extra measures such as reducing the time outdoor and wearing masks when necessary. For reducing the air pollutants indoor, people should use clean fuels and improve the stoves so as to burn fuel more efficiently and vent emissions to the outside. Air cleaners that can improve the air quality efficiently are recommended.
            </b>
            <h2 className="sub">
            4) <span className="text-red">Prevent</span> Infection
            </h2>
            <img className="prev-image" src={require("../images/mask.jpg")} alt="" />
            <b className="prev-body">
            ...
            <img className="prev-image" src={require("../images/doctor.jpg")} alt="" />
            <b className="prev-body">
            ...
            <br />
            In this fast-paced life, where we are always on the go, we hardly spare any time for ourselves – to review our health condition, check whether or not we are eating properly, taking ample amount of sleep, exercising regularly, and so on. <br />
             While we aren’t unaware of the fact that all these petty things are what exactly govern our lives and help us stay fit and healthy, we pay the least attention to our condition, until we’ve run out of time. We fall sick only to discover, we’ve been lethargic and ignorant about our health issues we already knew were brewing since a long time.
            </b>
            
            <h2 className="sub">
            6)<span className="text-red">Start</span> Exercising
            </h2>
            <img className="prev-image" src={require("../images/exercise.jpg")} alt="" />
            <b className="prev-body">
